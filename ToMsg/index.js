...
(async () => {
    ...
    // 生成基础表情
    {
        ...
        fs.copySync('./lib/emojiByBase/EmojiAliasMap', path.join(FILE_DIR_OUT_DIR, 'baseEmoji'));
    }
    // 生成自定义表情
    {
    ...
    if (!fs.existsSync('./dist/ASSET_FILES.json')) {
    ...
    fs.writeFileSync(`./dist/wechat-${leftNum}.json`, JSON.stringify(msgArr, null, 4));
